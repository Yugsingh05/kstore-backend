...
var swaggerUI = require('@fastify/swagger-ui');
...
var productRoutes = require('./src/routes/products');
var salesRoutes = require('./src/routes/sales');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.sent();
                    fastify.swagger();
                    return [4 /*yield*/, fastify.listen({ port: 3000, host: '0.0.0.0' })];
                case 2:
                    _a.sent();
